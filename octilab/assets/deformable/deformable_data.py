...
class DeformableData:
    ...
    default_nodal_positions: torch.Tensor = None

    default_nodal_velocities: torch.Tensor = None

    ##
    # Frame states.
    ##
    root_nodal_positions: torch.Tensor = None

    root_nodal_velocities: torch.Tensor = None
