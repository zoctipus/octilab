...
class JointAction(ActionTerm):
    ...
    def __init__(self, cfg: actions_cfg.JointActionCfg, env: ManagerBasedEnvCfg) -> None:
...
class JointPositionAction(JointAction):
    ...
    def __init__(self, cfg: actions_cfg.JointPositionActionCfg, env: ManagerBasedEnvCfg):
        # initialize the action term
        super().__init__(cfg, env)
...
class RelativeJointPositionAction(JointAction):
    ...
    def __init__(self, cfg: actions_cfg.RelativeJointPositionActionCfg, env: ManagerBasedEnvCfg):
        # initialize the action term
        super().__init__(cfg, env)
...
class ExponentialMovingAverageJointPositionAction(JointPositionAction):
    ...
    def __init__(self, cfg: actions_cfg.ExponentialMovingAverageJointPositionActionCfg, env: ManagerBasedEnvCfg):
        # initialize the action term
        super().__init__(cfg, env)
...
class JointVelocityAction(JointAction):
    ...
    def __init__(self, cfg: actions_cfg.JointVelocityActionCfg, env: ManagerBasedEnvCfg):
        # initialize the action term
        super().__init__(cfg, env)
...
class JointEffortAction(JointAction):
    ...
    def __init__(self, cfg: actions_cfg.JointEffortActionCfg, env: ManagerBasedEnvCfg):
        super().__init__(cfg, env)
