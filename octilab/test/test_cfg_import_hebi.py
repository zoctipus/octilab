...
class TestSpawningFromFiles(unittest.TestCase):
    ...
    def test_spawn_mjcf(self):
        """Test loading prim from Mjcf file"""
        cfg = sim_utils.UsdFileCfg(usd_path="/home/octipus/Projects/FineOrbit/tycho_env-master/tycho_env/assets/hebi.usd")
        prim = cfg.func("/World/Hebi", cfg)
        self.assertTrue(prim.IsValid())
        self.assertTrue(prim_utils.is_prim_path_valid("/World/Hebi"))
